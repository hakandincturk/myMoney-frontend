...
export const transactionApi = createApi({
  ...
  endpoints: (build) => ({
    ...
    listTransactionInstallments: build.query<ApiResponse<Array<{ id: number; amount: number; debtDate: string; installmentNumber: number; description?: string; paidDate?: string; paid: boolean; status?: 'ACTIVE' | 'SKIPPED' }>>, number>({
